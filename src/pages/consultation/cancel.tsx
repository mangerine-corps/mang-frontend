                    ...
                    <VStack bg='white' mx={{ base: "0", md: 4, lg: 4, xl: 4 }}
                            ...
                            >
                                <VStack w="full" alignItems="flex-start" gap={2} mb={2}>
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="Briefly tell us why you’re cancelling (optional)"
                                        p={3}
                                        color="text_primary"
                                        minH="100px"
                                    />
                        ...
                        <AreyouCancellingModal
                            ...
                            onConfirm={async () => {
                                ...
                                try {
                                    await cancelAppointment({ appointmentId: consultation_id, reason: cancelReason?.trim() || undefined }).unwrap();
                                    router.push('/consultation')
                                } catch (e) {
