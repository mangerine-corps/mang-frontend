...
// import EditConsultDrawer from "../../components/ui-components/editconsultantprofiledrawer";
import { BiSolidEditAlt } from "react-icons/bi";
import { IoEllipsisVerticalOutline } from "react-icons/io5";
import { useRouter } from "next/router";
import BlockConsultant from "./ui-components/modals/blockconsultant";
import { toaster } from "./ui/toaster";
import { useUnblockUserMutation } from "mangarine/state/services/profile.service";
// import BlockConsultant from "../../components/ui-components/modals/blockconsultant";
...
const BlockedConsultant = ({
  ...
  const [block, setBlock] = useState<boolean>(false);
    ...
    const [unblockUser, { isLoading: blocking }] = useUnblockUserMutation();
