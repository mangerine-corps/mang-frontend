...
const UnBlockConsultant = ({ onOpenChange, isOpen }: props) => {
  return (
    <Dialog.Root
      lazyMount
      open={isOpen}
            ...
            <Dialog.Body p="8" rounded={"xl"} bg="bg_box">
              ...
              >
                ...
                <Text
                  ...
                  fontWeight={"600"}
                >
              Are you sure you want to unblock Sharon Grace?
                </Text>
                ...
                <Text
                  ...
                  fontWeight={"400"}
                >
                 You will be able to see their profile and messages again.
                </Text>
              </VStack>
              {/* <ScheduleCard
...
export default UnBlockConsultant;
