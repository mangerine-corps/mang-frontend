...
const RescheduleSuccessful = ({ onOpenChange, isOpen }: props) => {
  return (
    <Dialog.Root
      lazyMount
      open={isOpen}
            ...
            <Dialog.Body p="8" rounded={"xl"} bg="bg_box">
              ...
              >
                ...
                <Text
                  ...
                  fontWeight={"400"}
                >
                  Your consultation has been successfully rescheduled. Check
                  your new appointment in the calendar.
                </Text>
              </VStack>
              {/* <ScheduleCard
...
export default RescheduleSuccessful;
