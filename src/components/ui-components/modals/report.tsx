...
const ReportConsultant = ({ onOpenChange, isOpen }: props) => {
  return (
    <Dialog.Root
      lazyMount
      open={isOpen}
            ...
            <Dialog.Body p="8" rounded={"xl"} bg="bg_box">
              ...
              >
                ...
                <Text
                  ...
                  fontWeight={"400"}
                >
                  Thank you for keeping mangerine and her users safe. We take
                  reports very seriously and will review this case as soon as
                  possible.
                </Text>
              </VStack>
              {/* <ScheduleCard
...
export default ReportConsultant;
