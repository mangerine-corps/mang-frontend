...
import { useReportGroupMutation, useReportPostMutation } from "mangarine/state/services/posts.service";
...
const ReportGroup = ({ onOpenChange, isOpen, data, userId }: props) => {
 ...
 console.log(grpId,"here")
  ...
  console.log(formdata, "data")
    reportGroup(formdata)
      ...
      .catch((error) => {
        console.error("Error reporting Group:", error, formdata);
        toaster.create({
          description: error?.data?.message || "Failed to report Group.",
          type: "error",
          closable: true,
        });
      });
