import { Button, Dialog, HStack, Portal, Stack, Text, Textarea, VStack } from "@chakra-ui/react";
...
const AppointmentDetails = ({ onOpenChange, isOpen }: props) => {
